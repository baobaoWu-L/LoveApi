...
export function SystemBrand(props: SystemBrandProps) {
  ...
  const name = status?.system_name || props.defaultName || 'LovebreakerApi'
  const version =
    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <SidebarMenuButton
          ...
          render={<div />}
        >
          <div className='flex aspect-square size-11 items-center justify-center overflow-hidden rounded-lg'>
            <img
              src={logo}
              alt={t('Logo')}
