...
// Default behavior: retry for 1xx, 3xx, 4xx(except 400/408), and all 5xx
// (including 502/504/524 upstream gateway timeouts), no retry for 2xx.
// Allowing 5xx to retry lets a failing channel seamlessly fall back to another.
